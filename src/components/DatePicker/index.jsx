  ...
  return (
    <section className="DatePicker-container">
      ...
      <div className="DatePicker-container-wrapper">
        <div className="DataPicker-tittle">
          <h1>Find your flight</h1>
        </div>
        <div className="DataPicker-header__wrapper">
          <div className="DatePocker-informacion">
          ...
          <div className="DatePicker-from-to__wraper">
           ...
           <div className="DataPicker-Today">
            <span>today</span>
            <h1>houston</h1>
          ...
          <div className="DatePicker-calendary__global">
            <div className="DatePicker-Departure">
              <p>Departure date</p>
            ...
            <div className='DatePicker-world'>
